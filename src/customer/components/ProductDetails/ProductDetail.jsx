  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 text-justify">
              ...
              <h1 className="text-lg lg:text-xl opacity-60 pt-1 text-grey-900">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                {/* <Button variant="contained" color="secondary" sx={{p:"2rem ", py:'1rem'}} >Add to Cart</Button> */}
                <Button
                  type="submit"
        ...
        <section className="dellBox mx-auto">
          <h1 className="font-semibold text-lg pb-4 text-justify">
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid className="dell" item xs={12} sm={5}>
                <h1 className="text-xl font-semibold pb-2 text-justify">
                  Product Ratings
                </h1>
                <div className="flex items-center space-x-3">
                  <Rating readOnly value={4.5} precision={0.5} />
                  <p className="opacity-60">564545 Ratings</p>
                </div>
        ...
        <section className="pt-10 mx-auto">
          ...
          <div className="grid grid-cols-1 max-[415px]:grid-cols-1 max-[639px]:grid-cols-2 sm:grid-cols-3 lg:grid-cols-3.5 xl:grid-cols-5 2xl:grid-cols-6 gap-8">
            {mens_kurta.slice(22).map((item) => (
